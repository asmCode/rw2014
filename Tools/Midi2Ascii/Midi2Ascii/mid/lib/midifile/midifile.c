...
DECLSPEC int (*Mf_getc)() = NULLFUNC;
DECLSPEC void (*Mf_error)() = NULLFUNC;
DECLSPEC void (*Mf_header)() = NULLFUNC;
DECLSPEC void (*Mf_starttrack)() = NULLFUNC;
DECLSPEC void (*Mf_endtrack)() = NULLFUNC;
DECLSPEC void (*Mf_on)() = NULLFUNC;
DECLSPEC void (*Mf_off)() = NULLFUNC;
DECLSPEC void (*Mf_pressure)() = NULLFUNC;
DECLSPEC void (*Mf_parameter)() = NULLFUNC;
DECLSPEC void (*Mf_pitchbend)() = NULLFUNC;
DECLSPEC void (*Mf_program)() = NULLFUNC;
DECLSPEC void (*Mf_chanpressure)() = NULLFUNC;
DECLSPEC void (*Mf_sysex)() = NULLFUNC;
DECLSPEC void (*Mf_arbitrary)() = NULLFUNC;
DECLSPEC void (*Mf_metamisc)() = NULLFUNC;
DECLSPEC void (*Mf_seqnum)() = NULLFUNC;
DECLSPEC void (*Mf_eot)() = NULLFUNC;
DECLSPEC void (*Mf_smpte)() = NULLFUNC;
DECLSPEC void (*Mf_tempo)() = NULLFUNC;
DECLSPEC void (*Mf_timesig)() = NULLFUNC;
DECLSPEC void (*Mf_keysig)() = NULLFUNC;
DECLSPEC void (*Mf_sqspecific)() = NULLFUNC;
DECLSPEC void (*Mf_text)() = NULLFUNC;

/* Functions to implement in order to write a MIDI file */
DECLSPEC int (*Mf_putc)() = NULLFUNC;
DECLSPEC void (*Mf_wtrack)() = NULLFUNC;
DECLSPEC void (*Mf_wtempotrack)() = NULLFUNC;

DECLSPEC int Mf_nomerge = 0; /* 1 => continue'ed system exclusives are */
                             /* not collapsed. */
DECLSPEC long Mf_currtime = 0L;	/* current time in delta-time units */
 ...
 *
 */
DECLSPEC float mf_ticks2sec(unsigned long ticks, int division,
        unsigned int tempo)
{
...
DECLSPEC unsigned long mf_sec2ticks(float secs, int division,
        unsigned int tempo)
{    
...
DECLSPEC int Mf_RunStat = 0;    /* if nonzero, use running status */
 ...
 */
DECLSPEC int mf_w_midi_event(unsigned long delta_time,
 ...
 */
DECLSPEC int mf_w_meta_event(unsigned long delta_time,
 ...
 */
DECLSPEC int mf_w_sysex_event(unsigned long delta_time,
...
DECLSPEC void mf_w_tempo(unsigned long delta_time, unsigned long tempo)
{
    /* Write tempo */
...
DECLSPEC void mfwrite(int format, int ntracks, int division, FILE *fp) 
{
    int i;
